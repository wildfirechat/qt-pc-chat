...
const ChangeGroupNameNotificationContentPrototype ChangeGroupNameNotificationContent::sPrototype;
...
std::string ChangeGroupNameNotificationContent::digest(const Message &message) const {
