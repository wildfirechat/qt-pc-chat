...
namespace WFCLib {
const CallStartMessageContentPrototype CallStartMessageContent::sPrototype;
...
std::string CallStartMessageContent::digest(const Message &message) const { return audioOnly ? "[音频通话]" : "[视频通话]"; }
