...
const ChangeGroupPortraitNotificationContentPrototype ChangeGroupPortraitNotificationContent::sPrototype;
...
std::string ChangeGroupPortraitNotificationContent::digest(const Message &message) const {
